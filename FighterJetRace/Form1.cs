...
namespace FighterJetRace
{
    public partial class Form1 : Form
    {
        ...
        public void setup()
        {
            ...
            Data.jet[0] = new FighterJet() { JetImgImg = jetBlack, startPos = startPos, finalPos = RaceTrackLength };
            Data.jet[1] = new FighterJet() { JetImgImg = jetBlue, startPos = startPos, finalPos = RaceTrackLength };
            Data.jet[2] = new FighterJet() { JetImgImg = JetYellow, startPos = startPos, finalPos = RaceTrackLength };
            Data.jet[3] = new FighterJet() { JetImgImg = JetRed, startPos = startPos, finalPos = RaceTrackLength };
